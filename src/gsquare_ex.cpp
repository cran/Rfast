...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(g2Test(data,x,y,cs,dc));
    return __result;
END_RCPP
}
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(g2Test_univariate_perm(data,dc,nperm));
    return __result;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericMatrix >::type data(dataSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type dc(dcSEXP);
    __result = Rcpp::wrap(g2Test_univariate(data,dc));
    return __result;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericVector >::type dc(dcSEXP);
    Rcpp::traits::input_parameter< int >::type nperm(npermSEXP);
    __result = Rcpp::wrap(g2Test_perm(data,x,y,cs,dc,nperm));
    return __result;
END_RCPP
}
