...
SEXP Rfast_col_meds(SEXP xSEXP,SEXP na_rmSEXP);
...
SEXP Rfast_nth(SEXP xSEXP,SEXP ySEXP,SEXP descendSEXP);
SEXP Rfast_nth_index(SEXP xSEXP,SEXP ySEXP,SEXP descendSEXP);
...
SEXP Rfast_rank(SEXP xSEXP,SEXP methodSEXP,SEXP descendSEXP,SEXP stableSEXP);
...
SEXP Rfast_transpose_sq(SEXP xSEXP);
...
static const R_CallMethodDef CallEntries[] = {
  ...
  {"Rfast_col_meds", (DL_FUNC) &Rfast_col_meds, 2},
  ...
  {"Rfast_nth", (DL_FUNC) &Rfast_nth, 3},
  {"Rfast_nth_index", (DL_FUNC) &Rfast_nth_index, 3},
  ...
  {"Rfast_rank", (DL_FUNC) &Rfast_rank, 4},
  ...
  {"Rfast_transpose_sq", (DL_FUNC) &Rfast_transpose_sq, 1},
  ...
  {"Rfast_col_mads_p", (DL_FUNC) &Rfast_col_mads_p, 1},
