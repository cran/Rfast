...
vec group_sum2(vec, NumericVector, const int);
vec group_sum3(vec, vec,const int);
...
double rint_reg2(mat, vec, vec,vec,const int, const double,int);
...
double varcomps_mle2(vec, vec,const int,const double);
double rint_mle2(vec, vec, vec, const double, int);
double bic_rint_reg(mat, vec, vec, vec, const int, const double, int);
vec bic_rint_regs(mat, vec, vec, vec, const double, int, int);
...
mat varcomps_mle3(vec, vec,const int, const int,const bool, const double,const int);
